class EpisodesController < ApplicationController
  ...
  def index
    ...
    @episodes = @episodes.where(["number LIKE :filtro", :filtro => ("%" + params[:filtro] + "%")]) unless params[:filtro].blank?

    @episodes = @episodes.where(["title LIKE :filter_title", :filter_title => ("%" + params[:filter_title] + "%")]) unless params[:filter_title].blank?
